...
task main ()
{
	...
	int	x2 = (abs(joystick.joy1_x2) > t) ? joystick.joy1_x2 : 0;
		...
		motor [frontLeft] = ((egFrontLeftMotorSetting * precisionDriveScale) - ((joy1Btn(1) == 1) ? 20 : 0) + ((joy1Btn(3) == 1) ? 20 : 0));
		motor [frontRight] = ((egFrontRightMotorSetting * precisionDriveScale) + ((joy1Btn(1) == 1) ? 20 : 0) - ((joy1Btn(3) == 1) ? 20 : 0));
